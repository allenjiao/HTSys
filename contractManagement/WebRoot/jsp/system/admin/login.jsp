...
<head>
        <title>机房运行监控与管理系统平台</title><meta charset="UTF-8" />
    ...
    <body>
        <div id="loginbox">            
            <form action="login_login.do" method="post" name="loginForm" id="loginForm" onsubmit="return check();">
				 <div class="control-group normal_text"> <h3><img src="<%=path %>/admin00/login/logo.png" alt="Logo" />机房运行监控与管理系统平台</h3></div>
                ...
                <div class="form-actions" align="center">
                    ...
                    <span class="pull-right"><a onclick="denglu();" class="flip-link btn btn-info" id="to-recover">登录</a></span>
               		...
               		<div class="controls">
                        <div class="main_input_box">
                                  	<font color="white"><span id="nameerr">Copyright © HD 2015</span></font>
