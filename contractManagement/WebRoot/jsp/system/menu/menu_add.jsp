...
<body>
	<form  action="menu/add.do" name="menuForm" id="menuForm" method="post" >
		...
		<table>
			...
			<tr class="info">
				<td><input type="text" name="MENU_NAME" id="menuName" placeholder="这里输入菜单名称" value="${menu.MENU_NAME }" title="名称"/></td>
			</tr>
			<tr class="info">
				<td><input type="text" name="MENU_URL" id="menuUrl" placeholder="这里输入链接地址" value="${menu.MENU_URL }" title="地址"/></td>
			</tr>
			<tr class="info">
				<td><input type="number" name="MENU_ORDER" id="menuOrder" placeholder="这里输入序号" value="${menu.MENU_ORDER}" title="序号"/></td>
			</tr>
			<tr>
