...
<div id="page-content" class="clearfix">
  ...
  <div class="row-fluid">
	...
	<div class="row-fluid">
			...
			<!-- 检索  -->
			<form action="appuser/listUsers.do?isM1=${pdm.isM1 }&isM2=${pdm.isM2 }" method="post" name="userForm" id="userForm">
			<table>
				<tr>
	...
	<!-- PAGE CONTENT ENDS HERE -->
		...
		function delUser(userId){
			bootbox.confirm("确定要删除该记录?", function(result) {
				if(result) {
					var url = "appuser/deleteU.do?USER_ID="+userId+"&tm="+new Date().getTime();
