...
<body>
	<form action="equipment/addU.do" name="userForm" id="userForm" method="post">
				...
				<td style="vertical-align:top;">
					...
					<select class="chzn-select" name="EQUIPMENT_TYPE_ID">
						...
						<c:forEach items="${equipmentTypes}" var="equipmentTypes">
							<option value="${equipmentTypes.EQUIPMENT_TYPE_ID }" >${equipmentTypes.EQUIPMENT_TYPE_NAME }</option>
						</c:forEach>
					</select>
				</td>
			</tr>
				...
				<td style="vertical-align:top;">
					...
					<select class="chzn-select" name="PARENT_EQUIPMENT_ID">
						...
						<c:forEach items="${equipments}" var="equipments">
							<option value="${equipments.EQUIPMENT_ID }" >${equipments.EQUIPMENT_NAME }</option>
						</c:forEach>
					</select>
...
<!-- 				<td><input type="text" name="GATHER_SYSTEM_ID"   value="${pd.GATHER_SYSTEM_ID }" title="采集系统编码"/></td> -->
 				<td style="vertical-align:top;">
				...
				<td style="vertical-align:top;">
					<select class="chzn-select" id="BIZ_SYSTEM_ID"  name="BIZ_SYSTEM_ID">
						...
						<c:forEach items="${softwares}" var="softwares">
							<option value="${softwares.SOFTWARE_ID }">${softwares.SOFTWARE_NAME}</option>
						</c:forEach>
					</select>
				</td>
			</tr>
			...
			<tr>
				...
				<td style="vertical-align:top;">
					<select class="chzn-select" id="ALARM_STATUS"  name="ALARM_STATUS">
						<option value=""></option>
				...
				<td>
				<input class="span3 date-picker" name="PUTAWAY_TIME" value="${pd.PUTAWAY_TIME}" type="text" data-date-format="yyyy-mm-dd"/>
				</td>
			</tr>
			<tr>
